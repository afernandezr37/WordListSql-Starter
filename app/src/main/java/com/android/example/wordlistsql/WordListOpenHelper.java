...
public class WordListOpenHelper extends SQLiteOpenHelper {
     ...
     */
    @SuppressLint("Range")
    public com.android.example.wordlistsql.WordItem query(int position) {
        String query = "SELECT  * FROM " + WORD_LIST_TABLE +
                " ORDER BY " + KEY_WORD + " ASC " +
                "LIMIT " + position + ",1";

        Cursor cursor = null;
        com.android.example.wordlistsql.WordItem entry = new com.android.example.wordlistsql.WordItem();
