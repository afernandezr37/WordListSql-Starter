...
public class MainActivity extends AppCompatActivity {
    ...
    private com.android.example.wordlistsql.WordListAdapter mAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new com.android.example.wordlistsql.WordListAdapter(this, /* mDB.getAllEntries(),*/ mDB);
        ...
        if (requestCode == WORD_EDIT) {
            if (resultCode == RESULT_OK) {
                ...
                if (!TextUtils.isEmpty(word)) {
                    int id = data.getIntExtra(com.android.example.wordlistsql.WordListAdapter.EXTRA_ID, -99);
